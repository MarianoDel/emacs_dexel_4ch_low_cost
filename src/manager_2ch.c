...
// Module Functions ------------------------------------------------------------
void Manager_2Ch_Timeouts (void)
{
...
void Manager_2Ch (parameters_typedef * pmem)
{
...
unsigned char Manager_2Ch_Probe_Temp_Get (void)
{
    return check_probe_temp;
}
        

void Manager_2Ch_Probe_Temp_Set (void)
{
    check_probe_temp = 1;
}


void Manager_2Ch_Probe_Temp_Reset (void)
{
    check_probe_temp = 0;
}
